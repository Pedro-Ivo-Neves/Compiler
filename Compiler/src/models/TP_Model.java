...
public class TP_Model extends Token_Model{
    ...
    public TP_Model setBeforeToken(Object beforeToken){
        if(beforeToken instanceof PR_Model || beforeToken instanceof SE_Model){
            ...
            throw new LexicalExcepction("Antes de um \033[34mTipo Primitivo\033[0m, espera-se uma \033[33mPR\033[0m ou um \033[32mSE\033[0m! (linha:"+super.getLineIndex()+", coluna: "+super.getColumnIndex()+")");
        }
        return this;
    }
}
